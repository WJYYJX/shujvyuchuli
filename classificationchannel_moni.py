...
if __name__ == '__main__':
    train_image = []
    train_label = []
    path1 = r"F:\tongkongyingguan1"  # 包含四类的文件夹路径 C:\Users\111\Desktop\zhongzhuan\val
    ...
    for folder_name0 in os.listdir(path1):  # 一级文件夹里的子文件夹共分成四类
        ...
        for folder_name1 in os.listdir(path0):  # 获取其中一个子文件夹内的子文件夹名
            ...
            for folder_name2 in os.listdir(path2):  # 获取其中一个子文件夹内的子文件夹名
                ...
                source_file = path3 + '/16.bmp'
                savepath = r"F:\moniyan_channelclass"

                savepath0 = savepath + '/' +folder_name0 + '/' + folder_name1 + '/' + 'channl16'

                savepath1 = savepath0 + '/'  + folder_name2 + '_16'+ '.bmp'
