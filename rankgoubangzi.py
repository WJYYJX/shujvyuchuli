...
if __name__ == '__main__':
    path1 = "D:/goubangzi1000_1"  # 包含四类的文件夹路径#"C:/Users/111/Desktop/rank/"
    for folder_name0 in os.listdir(path1):  # 一级文件夹里的子文件夹共分成四类
        path4 = os.path.join(path1, folder_name0)
        for folder_name3 in os.listdir(path4):  # 一级文件夹里的子文件夹共分成四类
            path0 = os.path.join(path4, folder_name3)
